...
<body>
    <div class="container">
        <h2 class="header_form">Delete user</h2>
        <form class="sign_form" action="handlers/delete_user.php" method="post">
            <input class="input_field" type="text" name="username" placeholder="Username" required />
            <button class="main_button btn_style" type="submit">Delete user</button>
        </form>
