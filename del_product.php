<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['select_category'])) {
            $product_id = $_POST['select_category'];
            delete($pdo, "products", ["id" => $product_id]);
            write_into_session_and_go_to("del_product.php", 
...
<body>
    <div class="container">
        <h2 class="header_form">Delete product</h2>
        
        <form class="sign_form" method="post">
            <?php show_category_option($pdo, "products"); ?>
            <button class="main_button btn_style" type="submit">Delete product</button>
        </form>
